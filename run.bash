...
#ansible-playbook site.yml --become --ask-become-pass --become-user=root -i $inventories/production/hosts -e @inventories/production/group_vars/all --limit controllers -c paramiko
